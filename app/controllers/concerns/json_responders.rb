...
module JsonResponders
  ...
  def render_bad_request(message, data = {})
    render(json: { code: 400, message:, data: }, status: 400)
  end

  def render_not_found(message, data = {})
    render(json: { code: 404, message:, data: }, status: 404)
  end

  def render_unauthorized(message)
    render(json: { code: 401, message: }, status: :unauthorized)
  end
  ...
  def render_success_with_websocket(message, data = {}, serializer = nil, serializer_options = {}, method = nil,
    ...
    render(json: { code: 200, message:, data: serialized_data }, status: 200)
  end
  ...
  def render_updated(message, data = {})
    render(json: { code: 200, message:, data: }, status: 200)
  end
  ...
  def render_accepted(message, data = {})
    render(json: { code: 202, message:, data: }, status: 202)
  end
  ...
  def render_success_payload(message, data, serializer, serializer_options, extra_info)
    payload = { code: 200, message:, data: serialize(data, serializer, serializer_options) }
