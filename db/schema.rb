...
ActiveRecord::Schema[7.1].define(version: 20_240_328_023_311) do
  ...
  create_table 'enquiries', charset: 'utf8', collation: 'utf8_general_ci', force: :cascade do |t|
    t.string 'name', null: false
  ...
  create_table 'incoterms', charset: 'utf8', collation: 'utf8_general_ci', force: :cascade do |t|
  ...
  create_table 'quotes', charset: 'utf8', collation: 'utf8_general_ci', force: :cascade do |t|
  ...
  create_table 'shipping_details', charset: 'utf8', collation: 'utf8_general_ci', force: :cascade do |t|
  ...
  create_table 'shipping_informations', charset: 'utf8', collation: 'utf8_general_ci', force: :cascade do |t|
