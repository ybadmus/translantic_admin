...
ActiveRecord::Schema[7.1].define(version: 2024_03_28_023311) do
  ...
  create_table "enquiries", charset: "utf8mb3", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "incoterms", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "shipping_details", charset: "utf8mb3", force: :cascade do |t|
