...
incoterms = [{ abbr: 'EXW', description: 'Ex Works names where the shipment is available to the buyer, not loaded. The seller will not contract for any transportation.' }, { abbr: 'FCA', description: 'Free Carrier, unloaded at the sellers dock OR a named place where the shipment is available to the international carrier or agent, not loaded.' }, { abbr: 'FAS', description: 'Free Alongside Ship, named ocean port of shipment. Ocean shipments that are NOT containerized.' }, { abbr: 'FOB', description: 'Free Onboard vessel named ocean port of shipment. This term is used for ocean shipments only where it is important that the goods pass the ship rail.'}, { abbr: 'CFR', description: 'Cost and Freight, Named ocean port of destination. This term is used for ocean shipments that are not containerized.' }, { abbr: 'CIF', description: 'Cost, Insurance, and Freight, named ocean port of destination. This term is used for ocean shipments that are not containerized.' }, { abbr: 'CPT', description: 'Carriage Paid To, named place or port of destination. This term is used for air or ocean containerized and roll-on roll-off shipments.' }, { abbr: 'CIP', description: 'Carriage and Insurance Paid To, named place or port of destination. This term is used for air or ocean containerized and roll-on roll-off shipments. Arrival At Stated Destination' }, { abbr: 'DAF', description: 'Delivered At Frontier, named place of destination, by land, not unloaded. This term is used for any mode of transportation but must be delivered by land.' }, { abbr: 'DES', description: 'Delivered Ex-Ship, named port of destination, not unloaded. This term is used for ocean shipments only.' }, { abbr: 'DEQ', description: 'Delivered Ex-Quay, named port of destination, unloaded, not cleared. This term is used for ocean shipments only.' }, { abbr: 'DDU', description: 'Delivered Duty Unpaid, named place of destination, not unloaded, not cleared. This term is used for any mode of transportation.' }, { abbr: 'DDP', description: 'Delivered Duty Paid, named place of destination, not unloaded, cleared. This term is used for any mode of transportation.' }]

locations = [{ city: 'Accra', zip_code: '00233', country: 'Ghana' }, { city: 'Lagos', zip_code: '00234', country: 'Nigeria' }, { city: 'Lome', state: 'Maritime', zip_code: '00228', country: 'Togo' }, { city: 'Cotonou', zip_code: '00229', country: 'Benin' }, { city: 'Kuala Lumpur', zip_code: '0060', country: 'Malaysia' }, { city: 'Casablanca', zip_code: '00212', country: 'Morocco' }]
